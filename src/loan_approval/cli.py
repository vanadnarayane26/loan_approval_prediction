import argparse
import json
from loan_approval.models.train import train
...
def train_cli():
    parser = argparse.ArgumentParser(description="Loan Approval Model Training")
    parser.add_argument(
        "--data",
        type=str,
        required=True,
    ...
    train(data_path = args.data, config_path = args.config)
